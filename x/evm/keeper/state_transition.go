...
// RANDAO implementation. See https://github.com/decimalteam/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) ApplyMessageWithConfig(ctx sdk.Context,
	...
	valueMsg, convBool := uint256.FromBig(msg.Value)
	if convBool {
		// should have already been checked on Ante Handler
		return nil, errorsmod.Wrap(err, "msg.Value failed convert to uint256")
	}
	...
	if contractCreation {
		...
		ret, _, leftoverGas, vmErr = evm.Create(sender, msg.Data, leftoverGas, valueMsg)
		stateDB.SetNonce(sender.Address(), msg.Nonce+1)
	} else {
		ret, leftoverGas, vmErr = evm.Call(sender, *msg.To, msg.Data, leftoverGas, valueMsg)
	}
	...
	// for more info https://github.com/decimalteam/ethermint/issues/1085

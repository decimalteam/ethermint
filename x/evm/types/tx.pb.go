...
type MsgEthereumTxResponse struct {
	...
	// post_tx_error is the error returned by PostTxProcessing
	PostTxError string `protobuf:"bytes,6,opt,name=post_tx_error,json=postTxError,proto3" json:"post_tx_error,omitempty"`
}
...
var fileDescriptor_f75ac0a12d075f21 = []byte{
	...
	,
}
...
func (m *MsgEthereumTxResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PostTxError) > 0 {
		i -= len(m.PostTxError)
		copy(dAtA[i:], m.PostTxError)
		i = encodeVarintTx(dAtA, i, uint64(len(m.PostTxError)))
		i--
		dAtA[i] = 0x32
	}
	if m.GasUsed != 0 {
...
func (m *MsgEthereumTxResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PostTxError", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PostTxError = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])

...
// EventMessage
type EventNewAddressContract struct {
	// module which emits the event
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
}

func (m *EventNewAddressContract) Reset()         { *m = EventNewAddressContract{} }
func (m *EventNewAddressContract) String() string { return proto.CompactTextString(m) }
func (*EventNewAddressContract) ProtoMessage()    {}
func (*EventNewAddressContract) Descriptor() ([]byte, []int) {
	return fileDescriptor_432e0d592184bde3, []int{3}
}
func (m *EventNewAddressContract) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventNewAddressContract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventNewAddressContract.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventNewAddressContract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventNewAddressContract.Merge(m, src)
}
func (m *EventNewAddressContract) XXX_Size() int {
	return m.Size()
}
func (m *EventNewAddressContract) XXX_DiscardUnknown() {
	xxx_messageInfo_EventNewAddressContract.DiscardUnknown(m)
}

var xxx_messageInfo_EventNewAddressContract proto.InternalMessageInfo

func (m *EventNewAddressContract) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (*EventBlockBloom) Descriptor() ([]byte, []int) {
	return fileDescriptor_432e0d592184bde3, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*EventNewAddressContract)(nil), "ethermint.evm.v1.EventNewAddressContract")
...
var fileDescriptor_432e0d592184bde3 = []byte{
	...
	,
}
...
func (m *EventNewAddressContract) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventNewAddressContract) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventNewAddressContract) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventNewAddressContract) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventNewAddressContract) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventNewAddressContract: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventNewAddressContract: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

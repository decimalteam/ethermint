...
SIMAPP = ./app
HTTPS_GIT := https://github.com/decimalteam/ethermint.git
...
PACKAGE_NAME:=github.com/decimalteam/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/decimalteam/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/decimalteam/ethermint/tests/importer
